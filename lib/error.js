...
const ERR = {
    ...
    APP_SECRET32: new RSError('AppSecret must be 32 characters long.', 'app_secret32', 500),
    AUTH_EXISTS: new RSError('User auth already exists.', 'auth_exists', 400),
    AUTH_REQ: new RSError('Must send auth data. eg: {type:"email","username":"santosh@rumsan.com"}', 'auth_req', 400),
    EMAIL_REQ: new RSError('Email is required.', 'email_req', 400),
    MONGOOSE: new RSError('Mongoose is undefined.', 'mongoose', 500),
    LOGIN_INVALID: new RSError('Invalid username or password', 'login_invalid', 401),
    LOGIN_REQ: new RSError('Username and password are required.', 'password_req', 400),
    PASSWORD_REQ: new RSError('Password is required.', 'password_req', 400),
    PHONE_REQ: new RSError('Phone is required', 'phone_req', 400),
    TOKEN_INVALID: new RSError('Token is invalid or expired. Please get a new one.', 'token_invalid', 401),
    ...
    USERNAME_EXISTS: new RSError('Username already exists.', 'username_exists', 400),
